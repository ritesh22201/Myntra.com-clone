...
export const overflowXAxis={base : 'scroll', sm : 'scroll', md : 'none', lg : 'none', xl : 'none', '2xl' : 'none'};

export const displayProp={base : 'flex', sm : 'flex', md : 'grid', lg : 'grid', xl : 'grid', '2xl' : 'grid'};
...
export const width = { base: '95%', sm: '95%', md: '70%', lg: '33%', xl: '33%', '2xl': '33%' };